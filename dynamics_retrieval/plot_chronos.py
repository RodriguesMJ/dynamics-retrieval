...
def plot_ts(settings):
    ...
    for i in range(0, min(20, nmodes)):
        ...
        f(ts[0:settings.S-settings.q-1],  chrono[0:settings.S-settings.q-1], '%s/chrono_ts_%d_firsthalf.png'%(out_folder, i))
        f(ts[0:settings.S-settings.q-1], -chrono[0:settings.S-settings.q-1], '%s/chrono_ts_%d_firsthalf_minussign.png'%(out_folder, i))
