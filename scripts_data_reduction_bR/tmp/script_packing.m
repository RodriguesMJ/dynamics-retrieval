...
% LOAD REFLECTION N
load(fn, 'reflection_ns_light_sort');

uniqueID = uniqueID_light_sort;
reflection_ns = reflection_ns_light_sort;

clear uniqueID_light_sort reflection_ns_light_sort;
...
% to save
filename = sprintf('data_bR_light_sorted_%s_nS%d_nBrg%d.mat', ...
                   dataForm, ...
                   num_snapshot,...
