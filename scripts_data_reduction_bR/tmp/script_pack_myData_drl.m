...
n = '74437';
datatype = 'test_light_sorted';

% to load:
fileData = ['data_bR_', datatype, '_int_nS', n, '_nBrg52219.mat'];          
%fileInfo = 'light_sorted_collection_time_info.mat';
fileInfo = 'sorted_info.mat';

% to save:             
fileData_DRL = ['data_bR_', datatype, '_int_DRL_nS', n, '_nBrg52219.mat']; 
...
load(fileInfo, 'drls_light_sort')

drls = drls_light_sort;
...
qmax = 1./drls; % notice that diff_res_lim is in Angstrom
