...
#         matplotlib.pyplot.title('Time avg of the integrated positive and negative density surrounding atom sites', fontsize=30)
#         matplotlib.pyplot.gca().tick_params(axis='x', labelsize=25) 
#         matplotlib.pyplot.gca().tick_params(axis='y', labelsize=0) 
...
#         matplotlib.pyplot.scatter(range(75000, 75000+10*meanposden.shape[0], 10), negden_all, c='k', s=5)
...
#     XTicksLabels = ['1-RET', '1-G', '1-C', '1-B', '1-F',  
#                     '2-RET', '2-G', '2-C', '2-B', '2-F', 
#                     '3-RET', '3-G', '3-C', '3-B', '3-F',
#                     '4-RET', '4-G', '4-C', '4-B', '4-F',
#                     '5-RET', '5-G', '5-C', '5-B', '5-F']
...
#         matplotlib.pyplot.figure(figsize=(20,10))
#         matplotlib.pyplot.scatter(range(100, 100*(meanposden.shape[0]+1), 100), posden_all, c='b', s=5, label='', zorder=100)
#         matplotlib.pyplot.scatter(range(100, 100*(meanposden.shape[0]+1), 100), negden_all, c='b', s=5)
#         matplotlib.pyplot.scatter(range(chrono.shape[0]), abs(chrono), c='darkturquoise', s=5, label='', zorder=200)
#         matplotlib.pyplot.scatter(range(chrono.shape[0]), chrono**2, c='navajowhite', s=5, label='', zorder=0)
#         matplotlib.pyplot.axhline(y=0, xmin=0, xmax=1, c='k')    
#         matplotlib.pyplot.legend(fontsize=16)
#         matplotlib.pyplot.savefig('./allatoms_movie_mode_%d_chrono.png'%mode, dpi=4*96)
#         matplotlib.pyplot.close()
...
if __name__ == '__main__':
    ...
    for sigcutoff in sigcutoffs:
        ...
        RETA_label = '%s_RETA_C11_C12_C20'%label
        plot_atoms_density(meanposden, meannegden, path, RETA_label, RETA_atoms)
        
        #RET B C11, C12, C20
        RETB_atoms = [4853, 4854, 4863]
        RETB_label = '%s_RETB_C11_C12_C20'%label
        plot_atoms_density(meanposden, meannegden, path, RETB_label, RETB_atoms)